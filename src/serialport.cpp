...
bool SerialPort::initSerialPort(const char *port_path)
{
    ...
    YAML::Node config = YAML::LoadFile("/home/plusseven/音乐/port/Port_config.yaml");
...
//bool SerialPort::sendData( u_char *Tmap_data) {
//
//    bool write_stauts = write(fd, Tmap_data, sizeof(Tmap_data));
//    std::cout << "sizeof(Tmap_data): " <<  sizeof(Tmap_data) <<std::endl;
//    std::cout << "write_stauts: " << write_stauts << std::endl;
//    return write_stauts;
//}

//
//bool SerialPort::sendData(unsigned char Tmap_data[19]) {
//
//    int size = sizeof(Tmap_data);
//    int write_stauts = write(fd, Tmap_data, size);
//    std::cout << "sizeof(Tmap_data): " <<  size <<std::endl;
//    std::cout << "write_stauts: " << write_stauts << std::endl;
//    return write_stauts;
//}
